                ...
                <div className="row">
                  <div className="col-md-10 pt-5 mx-auto">
                    <div className="text-center">
                      <h2 className="text-bold">Doctor's Login</h2>
              ...
              {login.error && (
                <div className="col-md-12 text-center">
                  ...
                  <div className="col-md-12 text-center pt-2">
                    <h6 className="py-3" > Not a member? <Link to="/doctorsignup" className="btn text-danger"  >Sign Up</Link> </h6>
