...
const CommonProblems = () => {
  ...
  useEffect(() => {
    fetch('http://localhost:3000/getCommonProblems')
  ...
  useEffect(() => {
    async function fetchData() {
      const response = await axios.get(`http://localhost:3000/getCommonProblems?review=${selectedValue}`);
            ...
            <div className="d-flex ">
              ...
              <div className="mx-2" style={{ display: 'flex', alignItems: "center", justifyContent: 'center' }}>
                ...
                >
                  ...
                  <option value="1">Sort By 1st Month</option>
                  <option value="3">Sort By 3rd Month</option>
                  <option value="7">Sort By 7th Month</option>
